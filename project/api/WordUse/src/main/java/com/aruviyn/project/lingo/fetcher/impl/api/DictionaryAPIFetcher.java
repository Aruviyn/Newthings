...
public class DictionaryAPIFetcher extends APIFetcher {
	...
	public static void main(String[] args) {
		...
		DictionaryAPIFetcher dictionaryFetcher = new DictionaryAPIFetcher("https://api.dictionaryapi.dev/api/v2/entries/en/dog");
